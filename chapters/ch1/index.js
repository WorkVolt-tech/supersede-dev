...
export async function mountChapter1(__mountOptions = {}) {
  ...
  function renderHUD() {
    ...
    const moralCol  = moral >= 60 ? '#a0d0ff'
      : moral >= 20  ? '#c8e8a0'
      : moral >= -20 ? '#c8b96e'
      : moral >= -60 ? '#e07a40'
      :                '#e05555'
