...
export async function mountSkills(__mountOptions = {}) {
  ...
  function renderElementsTree() {
    ...
    if (_elSkills.length) {
      ...
      panel += '<p style="font-family:\'Cinzel\',serif;font-size:.7rem;color:'+tree.color+';margin:0 0 6px">⚔ '+tree.label+' Attack Skills <span style="color:#c9b88f;font-size:.6rem">('+_nUnlocked+'/19 nodes)</span></p>'
      for (let i = 0; i < 3; i++) {
