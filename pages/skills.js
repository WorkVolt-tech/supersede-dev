...
function installModuleStyle() {
  ...
  supp.textContent = `
    ...
    /* ── Blanket: no dark text anywhere in the dark skill-tree overlays. ── */
    #tree-overlay, #tree-overlay *,
    #elements-overlay, #elements-overlay *,
    #slots-bar, #slots-bar *,
    #node-detail, #node-detail *,
    #esp-overlay, #esp-overlay *,
    #esp-slot-chooser, #esp-slot-chooser * { color: #e8dcc0 !important; }
    /* Themed accents kept readable on dark: */
    #tree-overlay h2, #esp-overlay h2 { color: #ffe94d !important; }
    #elements-overlay h2 { color: #d4b4ff !important; }
    #tree-overlay button, #elements-overlay button, #slots-bar button,
    #node-detail button, #esp-overlay button, #esp-slot-chooser button { color: #f5efe0 !important; }
    #elements-overlay .el-tab.locked .el-tab-name,
    #elements-overlay .el-node.locked .el-node-lbl { color: #9a8a6a !important; }
    #elements-overlay .el-header-signature,
    #elements-overlay .el-node-cost,
    #elements-overlay .elements-badge { color: #d4b4ff !important; }
    #elements-overlay .el-node-ks .el-node-lbl,
    #tree-overlay .sp-badge { color: #ffe94d !important; }
    #elements-overlay .elements-sidebar-label,
    #elements-overlay .el-pass2-note { color: #f4c45a !important; }
    #tree-overlay .tree-reset-btn,
    #node-detail .slot-remove,
  ...
  if (!window._elDetailEscWired) {
    ...
    document.addEventListener('keydown', (e) => {
      if (e.key === 'Escape') {
        ...
        const sb = document.getElementById('slots-bar')
