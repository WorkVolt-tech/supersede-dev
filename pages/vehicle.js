...
export async function mountVehicle(__mountOptions = {}) {
  ...
  // EYE_FILES maps enemy.name.toLowerCase() -> filename in /assets/ride/enemy/.
  // The boss enemy is named 'Boss' (lowercased -> 'boss') but the actual
  // file is boss_eye.webp, so we map it explicitly. Cluster is omitted
  // (no asset yet) -- drawEye falls back to the geometric eyeball render
  // for any enemy without a matching image.
  const EYE_FILES = {
    scout:   'scout.webp',
